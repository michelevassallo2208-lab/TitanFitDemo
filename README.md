...
# Run and deploy your TitanFit app (Next.js)

This app runs on Next.js (App Router) with API routes for Neon Postgres.
...
3. Set the `DATABASE_URL` in `.env.local` to your Neon connection string
4. Run the app:
   `npm run dev`
...
4. Deploy. Vercel will build the Next.js app and the `/api` routes.
